...
const byte anemometer::query[8] = {0x01, 0x03, 0x00, 0x16, 0x00, 0x01, 0x65, 0xCE};
const byte anemometer::ex_reply[7] = {0x01, 0x03, 0x02, 0x00, 0x17, 0xF8, 0x4A}; // wind speed 2.3 m/s
